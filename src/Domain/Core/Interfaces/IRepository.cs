...
namespace Core.Interfaces
{
    public interface IRepository<T> where T : class
    {
        ...
        /// </summary>
        Task<IEnumerable<T>> GetAllAsync(string userId, Func<T, bool>? predicate = null, CancellationToken cancellationToken = default);

        /// <summary>
        /// Returns a <typeparamref name="T"/> entity by id.
        /// </summary>
        Task<T?> GetAsync(string id, string userId, CancellationToken cancellationToken = default);
