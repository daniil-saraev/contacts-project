...
{
    public class NavigateToContactEditViewCommand : BaseCommand
    {
        private readonly NavigationService _navigationService;
        private readonly SelectedContact _selectedContact;
        private readonly IViewModelsFactory _viewModelsFactory;

        public NavigateToContactEditViewCommand(SelectedContact selectedContact, IViewModelsFactory viewModelsFactory, Func<object?, bool>? canExecuteCustom = null) : base(canExecuteCustom)
        {
        ...
        {
            _navigationService.CurrentViewModel = _viewModelsFactory.GetViewModel<ContactEditViewModel>();
        }
    }
}
